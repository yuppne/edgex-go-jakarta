...
list](https://github.com/yuppne/edgex-go-jakarta/issues) to determine whether it already include the
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure
   ...
   git remote add upstream https://github.com/yuppne/edgex-go-jakarta.git
   ```
