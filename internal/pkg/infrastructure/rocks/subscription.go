...
func sendAddSubscriptionCmd(conn rocksClient.Client, storedKey string, subscription models.Subscription) errors.EdgeX {
...
func addSubscription(conn rocksClient.Client, subscription models.Subscription) (models.Subscription, errors.EdgeX) {
...
func allSubscriptions(conn rocksClient.Client, offset, limit int) (subscriptions []models.Subscription, edgeXerr errors.EdgeX) {
...
func subscriptionById(conn rocksClient.Client, id string) (subscription models.Subscription, edgexErr errors.EdgeX) {
...
func subscriptionByName(conn rocksClient.Client, name string) (subscription models.Subscription, edgeXerr errors.EdgeX) {
...
func subscriptionsByCategory(conn rocksClient.Client, offset int, limit int, category string) (subscriptions []models.Subscription, edgeXerr errors.EdgeX) {
...
func subscriptionsByLabel(conn rocksClient.Client, offset int, limit int, label string) (subscriptions []models.Subscription, edgeXerr errors.EdgeX) {
...
func subscriptionsByReceiver(conn rocksClient.Client, offset int, limit int, receiver string) (subscriptions []models.Subscription, edgeXerr errors.EdgeX) {
...
func deleteSubscriptionByName(conn rocksClient.Client, name string) errors.EdgeX {
...
func sendDeleteSubscriptionCmd(conn rocksClient.Client, storedKey string, subscription models.Subscription) {
...
func deleteSubscription(conn rocksClient.Client, subscription models.Subscription) errors.EdgeX {
	storedKey := subscriptionStoredKey(subscription.Id)
	_ = conn.Send(MULTI)
...
func updateSubscription(conn rocksClient.Client, subscription models.Subscription) errors.EdgeX {
...
func subscriptionsByCategoriesAndLabels(conn rocksClient.Client, offset int, limit int, categories []string, labels []string) (subscriptions []models.Subscription, edgeXerr errors.EdgeX) {
