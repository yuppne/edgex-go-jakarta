...
func addReading(conn rocksClient.Client, r models.Reading) (reading models.Reading, edgeXerr errors.EdgeX) {
	var m []byte
	var err error
...
func deleteReadingById(conn rocksClient.Client, id string) (edgeXerr errors.EdgeX) {
	r := models.BaseReading{}
...
func readingsByEventId(conn rocksClient.Client, eventId string) (readings []models.Reading, edgeXerr errors.EdgeX) {
...
func allReadings(conn rocksClient.Client, offset int, limit int) (readings []models.Reading, edgeXerr errors.EdgeX) {
...
func readingsByResourceName(conn rocksClient.Client, offset int, limit int, resourceName string) (readings []models.Reading, edgeXerr errors.EdgeX) {
...
func readingsByDeviceName(conn rocksClient.Client, offset int, limit int, name string) (readings []models.Reading, edgeXerr errors.EdgeX) {
...
func readingsByDeviceNameAndResourceName(conn rocksClient.Client, deviceName string, resourceName string, offset int, limit int) (readings []models.Reading, err errors.EdgeX) {
...
func readingsByDeviceNameAndResourceNameAndTimeRange(conn rocksClient.Client, deviceName string, resourceName string, startTime int, endTime int, offset int, limit int) (readings []models.Reading, err errors.EdgeX) {
...
func readingsByDeviceNameAndResourceNamesAndTimeRange(conn rocksClient.Client, deviceName string, resourceNames []string, startTime int, endTime int, offset int, limit int) (readings []models.Reading, totalCount uint32, err errors.EdgeX) {
...
func readingsByTimeRange(conn rocksClient.Client, startTime int, endTime int, offset int, limit int) (readings []models.Reading, edgeXerr errors.EdgeX) {
...
func readingsByResourceNameAndTimeRange(conn rocksClient.Client, resourceName string, startTime int, endTime int, offset int, limit int) (readings []models.Reading, edgeXerr errors.EdgeX) {
...
func readingsByDeviceNameAndTimeRange(conn rocksClient.Client, deviceName string, startTime int, endTime int, offset int, limit int) (readings []models.Reading, edgeXerr errors.EdgeX) {
