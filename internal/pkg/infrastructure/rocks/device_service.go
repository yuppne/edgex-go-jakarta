...
func deviceServiceNameExist(conn rocksClient.Client, name string) (bool, errors.EdgeX) {
...
func sendAddDeviceServiceCmd(conn rocksClient.Client, storedKey string, ds models.DeviceService) errors.EdgeX {
...
func addDeviceService(conn rocksClient.Client, ds models.DeviceService) (addedDeviceService models.DeviceService, edgeXerr errors.EdgeX) {
...
func deviceServiceById(conn rocksClient.Client, id string) (deviceService models.DeviceService, edgeXerr errors.EdgeX) {
...
func deviceServiceByName(conn rocksClient.Client, name string) (deviceService models.DeviceService, edgeXerr errors.EdgeX) {
...
func sendDeleteDeviceServiceCmd(conn rocksClient.Client, storedKey string, ds models.DeviceService) {
	wo := grocksdb.NewDefaultWriteOptions()
	db := conn.Database
...
func deleteDeviceService(conn rocksClient.Client, ds models.DeviceService) errors.EdgeX {
	storedKey := deviceServiceStoredKey(ds.Id)
	// _ = conn.Send(MULTI)
...
func deleteDeviceServiceById(conn rocksClient.Client, id string) errors.EdgeX {
...
func deleteDeviceServiceByName(conn rocksClient.Client, name string) errors.EdgeX {
...
func deviceServicesByLabels(conn rocksClient.Client, offset int, limit int, labels []string) (deviceServices []models.DeviceService, edgeXerr errors.EdgeX) {
...
func updateDeviceService(conn rocksClient.Client, ds models.DeviceService) errors.EdgeX {
