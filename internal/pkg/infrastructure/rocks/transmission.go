...
func transmissionById(conn rocksClient.Client, id string) (trans models.Transmission, edgexErr errors.EdgeX) {
...
func sendAddTransmissionCmd(conn rocksClient.Client, storedKey string, trans models.Transmission) errors.EdgeX {
...
func addTransmission(conn rocksClient.Client, trans models.Transmission) (models.Transmission, errors.EdgeX) {
...
func sendDeleteTransmissionCmd(conn rocksClient.Client, storedKey string, trans models.Transmission) {
	wo := grocksdb.NewDefaultWriteOptions()
	db := conn.Database
...
func updateTransmission(conn rocksClient.Client, trans models.Transmission) errors.EdgeX {
...
func deleteTransmissionById(conn rocksClient.Client, id string) errors.EdgeX {
...
func transmissionsByTimeRange(conn rocksClient.Client, startTime int, endTime int, offset int, limit int) (transmissions []models.Transmission, edgeXerr errors.EdgeX) {
...
func allTransmissions(conn rocksClient.Client, offset, limit int) (transmissions []models.Transmission, edgeXerr errors.EdgeX) {
...
func transmissionsByStatus(conn rocksClient.Client, offset int, limit int, status string) (transmissions []models.Transmission, err errors.EdgeX) {
...
func transmissionsBySubscriptionName(conn rocksClient.Client, offset int, limit int, subscriptionName string) (transmissions []models.Transmission, err errors.EdgeX) {
...
func transmissionsByNotificationId(conn rocksClient.Client, offset int, limit int, id string) (transmissions []models.Transmission, err errors.EdgeX) {
...
func transmissionStoreKeys(conn rocksClient.Client, collectionKey string, age int64) ([]string, errors.EdgeX) {
