...
func addEvent(conn rocksClient.Client, e models.Event) (addedEvent models.Event, edgeXerr errors.EdgeX) {
...
func deleteEventById(conn rocksClient.Client, id string) (edgeXerr errors.EdgeX) {
...
func getEventReadingIdsByKeyScoreRange(conn rocksClient.Client, key string, min string, max string) (eventIds []string, readingIds []string, edgeXerr errors.EdgeX) {
...
func eventById(conn rocksClient.Client, id string) (event models.Event, edgeXerr errors.EdgeX) {
...
func (c *Client) allEvents(conn rocksClient.Client, offset int, limit int) (events []models.Event, edgeXerr errors.EdgeX) {
...
func eventsByDeviceName(conn rocksClient.Client, offset int, limit int, name string) (events []models.Event, edgeXerr errors.EdgeX) {
...
func eventsByTimeRange(conn rocksClient.Client, startTime int, endTime int, offset int, limit int) (events []models.Event, edgeXerr errors.EdgeX) {
...
func convertObjectsToEvents(conn rocksClient.Client, objects [][]byte) (events []models.Event, edgeXerr errors.EdgeX) {
