...
func sendAddDeviceCmd(conn rocksClient.Client, storedKey string, d models.Device) errors.EdgeX {
	...
	db := conn.Database
	err = db.Put(wo, []byte(storedKey), dsJSONBytes)
...
func addDevice(conn rocksClient.Client, d models.Device) (models.Device, errors.EdgeX) {
...
func deviceById(conn rocksClient.Client, id string) (device models.Device, edgeXerr errors.EdgeX) {
...
func deviceByName(conn rocksClient.Client, name string) (device models.Device, edgeXerr errors.EdgeX) {
...
func deleteDeviceById(conn rocksClient.Client, id string) errors.EdgeX {
...
func deleteDeviceByName(conn rocksClient.Client, name string) errors.EdgeX {
...
func sendDeleteDeviceCmd(conn rocksClient.Client, storedKey string, device models.Device) {
	wo := grocksdb.NewDefaultWriteOptions()
	db := conn.Database
...
func deleteDevice(conn rocksClient.Client, device models.Device) errors.EdgeX {
...
func devicesByServiceName(conn rocksClient.Client, offset int, limit int, name string) (devices []models.Device, edgeXerr errors.EdgeX) {
...
func devicesByLabels(conn rocksClient.Client, offset int, limit int, labels []string) (devices []models.Device, edgeXerr errors.EdgeX) {
...
func devicesByProfileName(conn rocksClient.Client, offset int, limit int, profileName string) (devices []models.Device, edgeXerr errors.EdgeX) {
...
func updateDevice(conn rocksClient.Client, d models.Device) errors.EdgeX {
