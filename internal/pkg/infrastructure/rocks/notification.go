...
func sendAddNotificationCmd(conn rocksClient.Client, storedKey string, n models.Notification) errors.EdgeX {
...
func addNotification(conn rocksClient.Client, notification models.Notification) (models.Notification, errors.EdgeX) {
...
func notificationsByCategory(conn rocksClient.Client, offset int, limit int, category string) (notifications []models.Notification, edgeXerr errors.EdgeX) {
...
func notificationsByLabel(conn rocksClient.Client, offset int, limit int, label string) (notifications []models.Notification, edgeXerr errors.EdgeX) {
...
func notificationById(conn rocksClient.Client, id string) (notification models.Notification, edgexErr errors.EdgeX) {
...
func notificationsByStatus(conn rocksClient.Client, offset int, limit int, status string) (notifications []models.Notification, edgeXerr errors.EdgeX) {
...
func notificationsByTimeRange(conn rocksClient.Client, startTime int, endTime int, offset int, limit int) (notifications []models.Notification, edgeXerr errors.EdgeX) {
...
func sendDeleteNotificationCmd(conn rocksClient.Client, storedKey string, n models.Notification) {
...
func deleteNotificationById(conn rocksClient.Client, id string) errors.EdgeX {
...
func updateNotification(conn rocksClient.Client, n models.Notification) errors.EdgeX {
...
func notificationsByCategoriesAndLabels(conn rocksClient.Client, offset int, limit int, categories []string, labels []string) (notifications []models.Notification, edgeXerr errors.EdgeX) {
...
func notificationAndTransmissionStoreKeys(conn rocksClient.Client, collectionKey string, age int64) ([]string, []string, errors.EdgeX) {
