...
func sendAddProvisionWatcherCmd(conn rocksClient.Client, storedKey string, pw models.ProvisionWatcher) errors.EdgeX {
...
func addProvisionWatcher(conn rocksClient.Client, pw models.ProvisionWatcher) (addedProvisionWatcher models.ProvisionWatcher, edgexErr errors.EdgeX) {
...
func provisionWatcherById(conn rocksClient.Client, id string) (provisionWatcher models.ProvisionWatcher, edgexErr errors.EdgeX) {
...
func provisionWatcherByName(conn rocksClient.Client, name string) (provisionWatcher models.ProvisionWatcher, edgexErr errors.EdgeX) {
...
func provisionWatchersByServiceName(conn rocksClient.Client, offset int, limit int, name string) (provisionWatchers []models.ProvisionWatcher, edgexErr errors.EdgeX) {
...
func provisionWatchersByProfileName(conn rocksClient.Client, offset int, limit int, name string) (provisionWatchers []models.ProvisionWatcher, edgexErr errors.EdgeX) {
...
func provisionWatchersByLabels(conn rocksClient.Client, offset int, limit int, labels []string) (provisionWatchers []models.ProvisionWatcher, edgexErr errors.EdgeX) {
...
func deleteProvisionWatcherByName(conn rocksClient.Client, name string) errors.EdgeX {
...
func sendDeleteProvisionWatcherCmd(conn rocksClient.Client, storedKey string, pw models.ProvisionWatcher) {
...
func deleteProvisionWatcher(conn rocksClient.Client, pw models.ProvisionWatcher) errors.EdgeX {
	storedKey := provisionWatcherStoredKey(pw.Id)
	_ = conn.Send(MULTI)
...
func updateProvisionWatcher(conn rocksClient.Client, pw models.ProvisionWatcher) errors.EdgeX {
