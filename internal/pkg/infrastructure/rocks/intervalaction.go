...
func sendAddIntervalActionCmd(conn rocksClient.Client, storedKey string, action models.IntervalAction) errors.EdgeX {
...
func addIntervalAction(conn rocksClient.Client, action models.IntervalAction) (models.IntervalAction, errors.EdgeX) {
...
func allIntervalActions(conn rocksClient.Client, offset, limit int) (intervalActions []models.IntervalAction, edgeXerr errors.EdgeX) {
...
func intervalActionByName(conn rocksClient.Client, name string) (action models.IntervalAction, edgeXerr errors.EdgeX) {
...
func sendDeleteIntervalActionCmd(conn rocksClient.Client, storedKey string, action models.IntervalAction) {
	wo := grocksdb.NewDefaultWriteOptions()
	db := conn.Database
...
func deleteIntervalActionByName(conn rocksClient.Client, name string) errors.EdgeX {
...
func intervalActionById(conn rocksClient.Client, id string) (action models.IntervalAction, edgeXerr errors.EdgeX) {
...
func updateIntervalAction(conn rocksClient.Client, action models.IntervalAction) errors.EdgeX {
...
func intervalActionsByIntervalName(conn rocksClient.Client, offset int, limit int, intervalName string) (actions []models.IntervalAction, edgeXerr errors.EdgeX) {
